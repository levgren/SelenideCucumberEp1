...
public class SearchResultPage {
    ...
    public boolean verifyDomainOnSearchResultPage(String expectedDomain, int numberOfSearchResultPages) {
        ...
        if (searchResult){
            Allure.addAttachment("Verifying expected domain on pageObjects.SearchResultPage", "Success. " + expectedDomain + " is present on result page");
        }else {
            Allure.addAttachment("Verifying expected domain on pageObjects.SearchResultPage", "Oops. There is no " + expectedDomain + " on result pages");
        }
        return searchResult;
    }
